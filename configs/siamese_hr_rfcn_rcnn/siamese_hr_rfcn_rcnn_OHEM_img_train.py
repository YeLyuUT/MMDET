...
model = dict(
    ...
    bbox_roi_extractor=dict(
            ...
            roi_layer=dict(type='PSRoIPoolAfterPointwiseConv', in_channels=480, out_channels=32*7*7, out_size=7, n_prev=0),
            out_channels=32,
            featmap_strides=[8]),
    bbox_head=dict(
...
log_level = 'INFO'
work_dir = './work_dirs/siamese_hr_rfcn_rcnn_OHEM_DETVID'
load_from = None
resume_from = None
workflow = [('train', 1)]
