...
test_cfg = dict(
    ...
    rcnn=dict(
        score_thr=0.03, nms=dict(type='nms', iou_thr=0.7), max_per_img=100),
    merged_rpn=dict(
        nms_across_levels=False,
        nms_pre=1000,
        nms_post=1000,
...
data = dict(
    ...
    test=dict(
        ...
        ann_file=data_root+'ImageSets/VID_val_jsons/%06d.json'%(88),
...
load_from = None #'./work_dirs/siamese_faster_rcnn_OHEM_DETVID_dcn/epoch_2.pth'
resume_from = None
workflow = [('train', 1)]
